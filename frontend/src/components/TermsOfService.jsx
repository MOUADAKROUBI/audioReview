...
const TermsOfService = () => {
  return (
    <div className="text-center">
      ...
      <p>
        By accessing this Website, accessible from www.lightfunnels.com, you are
      ...
      <p>
        ...
        on DigiTrust's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on DigiTrust's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let DigiTrust to terminate upon violations of any of these
      ...
      <p>
        All the materials on DigiTrust's Website are provided "as is". DigiTrust
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, DigiTrust does not make any
      ...
      <p>
        DigiTrust or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        DigiTrust's Website, even if DigiTrust or an authorize representative of
      ...
      <p>
        The materials appearing on DigiTrust's Website may include technical,
        typographical, or photographic errors. DigiTrust will not promise that
        any of the materials in this Website are accurate, complete, or current.
        DigiTrust may change the materials contained on its Website at any time
        without notice. DigiTrust does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        DigiTrust has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by DigiTrust of the site. The use
      ...
      <p>
        DigiTrust may revise these Terms of Use for its Website at any time
      ...
      <p>
        Any claim related to DigiTrust's Website shall be governed by the laws
